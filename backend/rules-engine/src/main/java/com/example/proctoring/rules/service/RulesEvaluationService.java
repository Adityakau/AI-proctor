...
import com.example.proctoring.rules.repository.AlertRepository;
import com.example.proctoring.rules.repository.AnomalyEventRepository;
import com.example.proctoring.rules.repository.ProctoringSessionRepository;
import com.example.proctoring.rules.repository.RiskScoreSnapshotRepository;
...
public class RulesEvaluationService {
    ...
    public void handleEvent(AnomalyEventMessage event) {
        ...
        // Persist raw anomaly event for auditing / dashboard drilldown.
