package com.example.proctoring.session.controller;

import com.example.proctoring.common.model.ProctoringSession;
import com.example.proctoring.session.service.SessionService;
...
public class SessionController {
    ...
    public ResponseEntity<?> heartbeat(@org.springframework.security.core.annotation.AuthenticationPrincipal Jwt jwt) {
        ...
        return ResponseEntity.ok(Map.of("sessionId", session.getId(), "lastHeartbeat", session.getLastHeartbeatAt().toString()));
    }
}
